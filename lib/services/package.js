...
var PackageDb = function (_EventEmitter) {
	_inherits(PackageDb, _EventEmitter);
  ...
  */
	...
	function PackageDb(ref) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PackageDb).call(this));
...
var store = new PackageDb('https://popping-fire-3177.firebaseio.com');
